...
var once = function(f) {
  return function() {
    var f_once = f;
    f = null;
    return f_once.apply(this, arguments);
  };
};
...
var revocable = function(f) {
  return {
    invoke: function() { return f.apply(this, arguments); },
    revoke: function() { f = null; }
  };
};
